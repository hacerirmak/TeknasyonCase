Feature: Uygulama izni verilerek yeni sekmelerin acilmasi
  ...
  Scenario: 1- Uygulama izni verilmesi
	...
	* Action bar butonuna tiklanir.
	* Action Bar Tabs butonuna tiklanir.
	* Toggle tab mode butonuna tiklanir.
	* Header alaninin pasife gectigi kontrol edilir.
	* Add new tab  butonuna uc kere tiklanir.
